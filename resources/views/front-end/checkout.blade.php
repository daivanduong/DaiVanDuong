    ...
    <div class="row">
      <div class="col l8">
        ...
        <div class="card-panel">
          ...
          <div class="card-panel">
            <p>
              <input  name="methodPay" value="cod" type="radio" checked="checked" id="test1" style="color: #FE642E" />
              <label for="test1">Thanh toán tiền mặt khi nhận hàng</label>
            </p>

            <p>
              <button class="btn waves-effect waves-light" type="submit" name="action" style="background-color: #FE642E">ĐẶT MUA
      ...
      <div class="col l4">
        <div class="panel-body">
          <div class="order">
            ...
            <a href="{{ route('cart.index') }}" class="btn" style="background-color: #FE642E">Sửa</a>
          </div>
          <div class="product">
