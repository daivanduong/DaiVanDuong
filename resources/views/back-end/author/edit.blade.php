...
<div class="row"> 
	<form class="col s12 m6" method="POST" action="{{ route('author.update',$author->id) }}">
     ...
     <div class="row">
        <div class="input-field col s12">
          <input disabled value="{{ count($books) }}" id="disabled" type="text" class="validate">
...
<form id="form-destroy" class="col s12 fmtDelete" method="POST" action="{{ route('author.destroy',$author->id) }}">
        {{ csrf_field() }}
        {{ method_field('DELETE') }}
</form>
  <div class="row">
