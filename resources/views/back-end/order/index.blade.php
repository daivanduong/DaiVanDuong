        ...
        <div ng-controller="MyController" class="my-controller l12">
          <div class="row">
              <div class="col s8">
                  ...
                  <input ng-model="q" autofocus id="search" class="form-control" placeholder="Nhập...">
              </div>
              <div class="col s4">
                  <label for="search">Số hàng</label>
            ...
            <table>
                  ...
                  <td><input ng-if="(order.order_status != 'Hủy đơn hàng' ) && (order.order_status != 'Giao hàng thành công' )" type="checkbox" name="order[]" value="{{order.orderId}}" class="filled-in" id="filled-in-box-{{order.orderId}}" /><label for="filled-in-box-{{order.orderId}}"></label></td>
                  <td>{{order.orderId}}</td>
